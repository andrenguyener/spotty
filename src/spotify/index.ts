 ...
 */
export const getUser = () => axios.get("https://api.spotify.com/v1/me", { headers: headers() });
 ...
 */
export const getTrackIds = (tracks: { track: { id: string } }[]) =>
 ...
 */
export const getAudioFeaturesForTracks = (tracks: { track: { id: string } }[]) => {
 ...
 */
export const getRecommendationsForTracks = (tracks: { track: { id: string } }[]) => {
